  ...
  <div class="min-h-screen bg-dark">
    ...
    <div v-else-if="!project && allProjects.length > 0" class="container mx-auto px-6 py-20 max-w-4xl">
      <div class="text-center">
        ...
        <router-link 
          to="/projects" 
          class="group inline-flex items-center px-6 py-3 bg-primary hover:bg-primary/80 text-dark rounded-lg transition-all duration-300 font-medium"
        >
          <span class="group-hover:text-blue-500">←</span> {{ t('projects.backToProjects') }}
        </router-link>
      </div>
    </div>
    ...
    <div v-else-if="project" class="container mx-auto px-6 py-12 max-w-6xl">
      <div class="mb-12">
        ...
        >
          <svg class="group-hover:text-blue-500 w-5 h-5 mr-2 transition-transform group-hover:-translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="space-y-8">
        ...
        <div class="text-center mb-8">
          ...
          <div class="flex flex-wrap justify-center gap-6 my-12">
            ...
            >
              <svg class=" group-hover:text-blue-500 w-6 h-6 mr-3 transition-transform group-hover:rotate-12" fill="currentColor" viewBox="0 0 20 20">
            ...
            >
              <svg class="group-hover:text-blue-500 w-6 h-6 mr-3 transition-transform group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
              </svg>
              {{ t('projects.viewProject') }}
              <div class="absolute inset-0 rounded-xl bg-white/20 group-hover:opacity-80 transition-opacity border-2 border-gray-400 duration-300"/>
            </a>
